          ...
          echo "<tr>";
              ...
              */
              ...
              if(!empty(trim(strip_tags($value->SERTT91_LOCALIDAD))))
                if(strlen(trim(strip_tags($value->SERTT91_LOCALIDAD)))>15)
                  echo "<td class='text-left'>".substr(trim(strip_tags($value->SERTT91_LOCALIDAD)),0,15)."... <i class='fa fa-search-plus pull-right' data-toggle='tooltip' title='' data-original-title='".trim(strip_tags($value->SERTT91_LOCALIDAD))."'></i></td>";
                else
              ...
              if(!empty(trim(strip_tags($value->GESTOR21_ALIAS))))
                if(strlen(trim(strip_tags($value->GESTOR21_ALIAS)))>15)
                  echo "<td class='text-left'>".substr(trim(strip_tags($value->GESTOR21_ALIAS)),0,15)."... <i class='fa fa-search-plus pull-right' data-toggle='tooltip' title='' data-original-title='".trim(strip_tags($value->GESTOR21_ALIAS))."'></i></td>";
                else
